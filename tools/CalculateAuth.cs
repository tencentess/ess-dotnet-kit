...
namespace TencentCloudExamples
{
    class CalculateAuth
    {
        ...
        public static void Main1(string[] args)
        {
            ...
            string service = "ess";
            string endpoint = "ess.tencentcloudapi.com";
            string region = "ap-guangzhou";
            string action = "DescribeFlowBriefs";
            string version = "2020-11-11";

            // 注意时区，建议此时间统一采用UTC时间戳，否则容易出错
            DateTime date = DateTime.UtcNow;
            string requestPayload = "{\"Action\":\"DescribeFlowBriefs\",Operator\":{\"UserId\":\"******************\"},\"FLowIds\":[\"*********************\"]}";
            ...
            Console.WriteLine("POST https://ess.tencentcloudapi.com");
